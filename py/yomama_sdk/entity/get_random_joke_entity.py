...
from yomama_sdk.yomama_types import (
    GetRandomJoke,
...
class GetRandomJokeEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return GetRandomJokeEntity(self._client, opts)
    ...
    def data_get(self) -> GetRandomJoke:
    ...
    def match_get(self) -> GetRandomJoke:
    ...
    def load(self, reqmatch=None, ctrl=None) -> GetRandomJoke:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.GetRandomJoke().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}

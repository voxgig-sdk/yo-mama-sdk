...
from yomama_sdk.utility import register

# Load features
from yomama_sdk.feature.base_feature import YoMamaBaseFeature
from yomama_sdk.features import _has_feature, _make_feature
...
class YoMamaSDK:
    ...
    def get_utility(self):
        return YoMamaUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("YoMamaSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Category(self, data=None) -> "CategoryEntity":
        ...
        from yomama_sdk.entity.category_entity import CategoryEntity
    ...
    def GetRandomJoke(self, data=None) -> "GetRandomJokeEntity":
        ...
        from yomama_sdk.entity.get_random_joke_entity import GetRandomJokeEntity
    ...
    def Joke(self, data=None) -> "JokeEntity":
        ...
        from yomama_sdk.entity.joke_entity import JokeEntity

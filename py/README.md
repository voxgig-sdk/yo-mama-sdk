...
The Python SDK for the YoMama API — an entity-oriented client following Pythonic conventions.
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/yo-mama-sdk/releases)) or
...
The main module (`yomama_sdk`) exports the SDK class.

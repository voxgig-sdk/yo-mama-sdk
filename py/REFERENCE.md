# YoMama Python SDK Reference

Complete API reference for the YoMama Python SDK.
...
#### `YoMamaSDK.test(testopts=None, sdkopts=None)`
...
#### `GetRandomJoke(data=None)`

Create a new `GetRandomJokeEntity` instance. Pass `None` for no initial data.
...
Create a new `GetRandomJokeEntity` instance with the same options.

...
class YoMamaTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = YoMamaTestRunner.getenv("YOMAMA_TEST_LIVE")
        override = YoMamaTestRunner.getenv("YOMAMA_TEST_OVERRIDE")
        ...
        explain = YoMamaTestRunner.getenv("YOMAMA_TEST_EXPLAIN")
        if explain is not None and explain != "":
            m["YOMAMA_TEST_EXPLAIN"] = explain

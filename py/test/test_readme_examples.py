# YoMama SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions YoMamaSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both YoMamaSDK(...) and YoMamaSDK.test(...) become
#      YoMamaSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "yomama_sdk"
_SDK_CLASS = "YoMamaSDK"

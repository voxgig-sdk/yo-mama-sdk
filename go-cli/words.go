...
func registerSDKWords(r *eng.Registry, client *sdk.YoMamaSDK) {
...
func runOp(client *sdk.YoMamaSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {

...
describe('GetRandomJokeDirect', async () => {
  ...
  test('direct-load-get_random_joke', async (t: any) => {
    const setup = directSetup({ id: 'direct01' })
    if (maybeSkipControl(t, 'direct', 'direct-load-get_random_joke', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['YO_MAMA_TEST_GET_RANDOM_JOKE_ENTID']

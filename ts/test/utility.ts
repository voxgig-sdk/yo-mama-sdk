...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.YO_MAMA_TEST_LIVE ||
    'TRUE' === process.env.YO_MAMA_TEST_OVERRIDE
  ) {
  ...
  m.YO_MAMA_TEST_EXPLAIN = process.env.YO_MAMA_TEST_EXPLAIN || m.YO_MAMA_TEST_EXPLAIN

...
class YoMamaTestRunner
{
    ...
    {
        $live = self::getenv('YO_MAMA_TEST_LIVE');
        $override = self::getenv('YO_MAMA_TEST_OVERRIDE');
        ...
        $explain = self::getenv('YO_MAMA_TEST_EXPLAIN');
...
class_alias('YoMamaTestRunner', 'Runner');
class_alias('YoMamaHelpers', 'Helpers');

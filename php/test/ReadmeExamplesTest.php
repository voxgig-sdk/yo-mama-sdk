...
// YoMama SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (YoMamaSDK::test)
...
{
    private const SDK_CLASS = 'YoMamaSDK';
    ...
    private const SDK_BASE = 'yomama_sdk';

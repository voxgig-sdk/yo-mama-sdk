...
class GetRandomJokeDirectTest extends TestCase
{
    public function test_direct_load_get_random_joke(): void
    {
        $setup = get_random_joke_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-get_random_joke", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {

...
class JokeEntity
{
     ...
     *
     * @param JokeListMatch|array|null $reqmatch Match filter (any subset
     *   of Joke fields) as an assoc-array; JokeListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Joke[]|array A list of Joke items as assoc-arrays at
     *   the SDK boundary; throws YoMamaError on failure (item-5 convention).
     */

...
class YoMamaFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; YoMamaSDK/1.0)';
    ...
    public static function call(YoMamaContext $ctx, string $fullurl, array $fetchdef): array
    {

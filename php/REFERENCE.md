# YoMama PHP SDK Reference

Complete API reference for the YoMama PHP SDK.
...
```php
require_once __DIR__ . '/yo-mama_sdk.php';
...
#### `YoMamaSDK::test($testopts = null, $sdkopts = null)`
...
#### `GetRandomJoke($data = null)`

Create a new `GetRandomJokeEntity` instance. Pass `null` for no initial data.

...
class YoMamaRbacFeature extends YoMamaBaseFeature
{
    ...
    private function _required(YoMamaContext $ctx): ?string
    {
    ...
    private function _reject(YoMamaContext $ctx, string $required): void
    {
    ...
    private function _track(YoMamaContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;

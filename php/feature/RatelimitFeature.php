...
class YoMamaRatelimitFeature extends YoMamaBaseFeature
{
    ...
    private function _acquire(YoMamaContext $ctx): void
    {
    ...
    private function _track(YoMamaContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;

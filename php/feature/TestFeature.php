...
// YoMama SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class YoMamaTestFeature extends YoMamaBaseFeature
{
    ...
    public function init(YoMamaContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (YoMamaContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (YoMamaContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(YoMamaContext $ctx, $op, $args): array
    {

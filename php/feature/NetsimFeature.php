...
class YoMamaNetsimFeature extends YoMamaBaseFeature
{
    ...
    private function _simulate(YoMamaContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(YoMamaContext $ctx, array $applied): void
    {
        $client = $this->client;

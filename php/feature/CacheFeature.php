...
class YoMamaCacheFeature extends YoMamaBaseFeature
{
    ...
    private function _through(YoMamaContext $ctx, string $url, array $fetchdef, callable $inner): array
    {

...
class YoMamaTimeoutFeature extends YoMamaBaseFeature
{
    ...
    private function _with_timeout(YoMamaContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(YoMamaContext $_ctx, float $ms): void
    {
        $client = $this->client;

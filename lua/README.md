...
The Lua SDK for the YoMama API — an entity-oriented client using Lua conventions.
...
GitHub release tag (`lua/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/yo-mama-sdk/releases)),
...
```
lua/
├── yo-mama_sdk.lua    -- Main SDK module
...
The main module (`yo-mama_sdk`) exports the SDK constructor

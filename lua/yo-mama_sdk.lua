...
YoMamaSDK._make_feature = _make_feature


function YoMamaSDK.new(options)
  local self = setmetatable({}, YoMamaSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function YoMamaSDK:options_map()
...
function YoMamaSDK:get_utility()
  return Utility.copy(self._utility)
end


function YoMamaSDK:get_root_ctx()
  return self._rootctx
end


function YoMamaSDK:prepare(fetchargs)
...
function YoMamaSDK:direct(fetchargs)
...
-- by passing it.
function YoMamaSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function YoMamaSDK:graphql(query, variables, ctrl)
...
function YoMamaSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = YoMamaSDK.new(sdkopts)
  sdk.mode = "test"

...
local GetRandomJokeEntity = {}
GetRandomJokeEntity.__index = GetRandomJokeEntity


function GetRandomJokeEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, GetRandomJokeEntity)
  self._name = "get_random_joke"
  self._client = client
...
function GetRandomJokeEntity:get_name()
  return self._name
end


function GetRandomJokeEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return GetRandomJokeEntity.new(self._client, opts)
end
...
function GetRandomJokeEntity:mark_deleted()
  self._deleted = true
end


function GetRandomJokeEntity:deleted()
  return true == self._deleted
end


function GetRandomJokeEntity:data_set(args)
  if args ~= nil then
...
function GetRandomJokeEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function GetRandomJokeEntity:match_set(args)
  if args ~= nil then
...
function GetRandomJokeEntity:match_get()
...
function GetRandomJokeEntity:stream(action, args, callopts)
...
---@param reqmatch GetRandomJokeLoadMatch
---@param ctrl? table
---@return GetRandomJoke
---@return string? err
function GetRandomJokeEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function GetRandomJokeEntity:_run_op(ctx, post_done)
  local utility = self._utility

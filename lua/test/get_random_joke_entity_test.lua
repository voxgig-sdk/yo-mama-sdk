...
describe("GetRandomJokeEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set YO_MAMA_TEST_GET_RANDOM_JOKE_ENTID JSON to run live")
      return
    end
...
function get_random_joke_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("YO_MAMA_TEST_GET_RANDOM_JOKE_ENTID")

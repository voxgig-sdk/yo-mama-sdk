...
describe("JokeDirect", function()
  it("should direct-list-joke", function()
    local setup = joke_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-joke", setup.live and "live" or "unit")

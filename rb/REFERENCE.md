# YoMama Ruby SDK Reference

Complete API reference for the YoMama Ruby SDK.
...
#### `YoMamaSDK.test(testopts = nil, sdkopts = nil)`
...
```ruby
results, err = client.Joke.list(nil)
```

...
The Ruby SDK for the YoMama API — an entity-oriented client using idiomatic Ruby conventions.
...
raise a `YoMamaError` (a `StandardError` subclass), so wrap

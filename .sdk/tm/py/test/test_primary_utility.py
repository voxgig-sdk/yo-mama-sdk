# YoMama SDK primary utility test
...
from projectname_sdk import YoMamaSDK
from projectname_sdk.core.spec import YoMamaSpec
from projectname_sdk.core.result import YoMamaResult
from projectname_sdk.core.response import YoMamaResponse
from projectname_sdk.core.operation import YoMamaOperation
from projectname_sdk.core.error import YoMamaError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import YoMamaBaseFeature
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = YoMamaSDK.test(None, None)
        ...
        class TestInitFeature(YoMamaBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(YoMamaBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = YoMamaSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = YoMamaSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = YoMamaSDK.test(None, setup_opts)

...
class YoMamaTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = YoMamaTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = YoMamaTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = YoMamaTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")

...
class YoMamaTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = YoMamaTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = YoMamaTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = YoMamaTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")

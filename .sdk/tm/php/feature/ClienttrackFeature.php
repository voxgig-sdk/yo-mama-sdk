...
// YoMama SDK clienttrack feature
...
class YoMamaClienttrackFeature extends YoMamaBaseFeature
{
    ...
    public function PostConstruct(YoMamaContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'YoMama-SDK';

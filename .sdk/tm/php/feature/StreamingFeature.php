...
class YoMamaStreamingFeature extends YoMamaBaseFeature
{
    ...
    private function _iterate(YoMamaResult $result): \Generator
    {
    ...
    private function _streamable(YoMamaContext $ctx): bool
    {

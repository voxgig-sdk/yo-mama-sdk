...
class YoMamaProxyFeature extends YoMamaBaseFeature
{
    ...
    public function init(YoMamaContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (YoMamaContext $ctx2, string $url2, array $fetchdef) use ($inner): array {

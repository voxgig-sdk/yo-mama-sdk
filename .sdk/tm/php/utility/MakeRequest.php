...
// YoMama SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class YoMamaMakeRequest
{
    public static function call(YoMamaContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new YoMamaResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new YoMamaResponse($fetched);
        } else {

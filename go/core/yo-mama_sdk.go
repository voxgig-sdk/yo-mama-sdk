...
func (sdk *YoMamaSDK) OptionsMap() map[string]any {
...
func (sdk *YoMamaSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *YoMamaSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *YoMamaSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *YoMamaSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *YoMamaSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *YoMamaSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("YoMamaSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *YoMamaSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *YoMamaSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("YoMamaSDK: graphql: %s", msg)
		res["graphql"] = errors
	}

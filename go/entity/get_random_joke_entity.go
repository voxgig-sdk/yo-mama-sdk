...
type GetRandomJokeEntity struct {
	name    string
	client  *core.YoMamaSDK
...
func NewGetRandomJokeEntity(client *core.YoMamaSDK, entopts map[string]any) *GetRandomJokeEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *GetRandomJokeEntity) GetName() string { return e.name }
...
func (e *GetRandomJokeEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *GetRandomJokeEntity) Deleted() bool {
	return e.deleted
}


func (e *GetRandomJokeEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewGetRandomJokeEntity(e.client, opts)
}

func (e *GetRandomJokeEntity) Data(args ...any) any {
...
func (e *GetRandomJokeEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an GetRandomJoke; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *GetRandomJokeEntity) DataTyped(data ...GetRandomJoke) GetRandomJoke {
	if len(data) > 0 {
		return typedFrom[GetRandomJoke](e.Data(asMap(data[0])))
	}
	return typedFrom[GetRandomJoke](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through GetRandomJoke (all fields
// optional at the wire level).
func (e *GetRandomJokeEntity) MatchTyped(match ...GetRandomJoke) GetRandomJoke {
	if len(match) > 0 {
		return typedFrom[GetRandomJoke](e.Match(asMap(match[0])))
	}
	return typedFrom[GetRandomJoke](e.Match())
}
...
func (e *GetRandomJokeEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *GetRandomJokeEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// GetRandomJokeLoadMatch and returns an GetRandomJoke. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *GetRandomJokeEntity) LoadTyped(reqmatch GetRandomJokeLoadMatch, ctrl map[string]any) (GetRandomJoke, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return GetRandomJoke{}, err
	}
	return typedFrom[GetRandomJoke](res), nil
}



func (e *GetRandomJokeEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *GetRandomJokeEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *GetRandomJokeEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *GetRandomJokeEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *GetRandomJokeEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
